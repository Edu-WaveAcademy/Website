...
Eduwave is a static GitHub Pages website with a private parent portal and an academy administration dashboard. The backend runs on Google Apps Script, stores operational data in Google Sheets, reads approved material from Google Drive, and sends passwordless login codes by email.
...
- Google Drive: private master resource folder
...
- Watermarked in-portal previews for approved Sheets, Docs, PDFs, and images
...
- Drive indexing without exposing permanent Drive links to parents
...
- `apps-script/Code.gs`: complete API, authorization, Sheet operations, and Drive rendering
...
- Keep the academy spreadsheet and Drive folder private.
